...
CONTEXT_LEN    = 16384  # max tokens model can hold (prompt + reply)
N_THREADS      = 16     # CPU threads
N_GPU_LAYERS   = -1     # -1=all layers on GPU

# --- generation settings ---
# Spanish tutor profile: warm, natural, conversational
MAX_TOKENS     = 512    # keep replies short and conversational — not essays
...
/story [topic]
  Generate a short story (200-250 words) at A2 level on the given topic.
